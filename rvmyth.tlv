...
\TLV
   ...
   m4_asm(SW, r0, r10, 100)           // Store final result in memory address 0x100
   m4_asm(LW, r15, r0, 100)           //r15 is destination
   // Optional:
...
       //I-type
      ...
      //       other than those specifically expected in the labs. You'll get strange errors for these.
         ...
         `BOGUS_USE($is_beq $is_bne $is_blt $is_bge $is_bltu $is_bgeu $is_sb $is_sh $is_sw $clk_arun)
