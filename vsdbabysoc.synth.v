...
module riscv_arun(OUT, CLK, reset);
  ...
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
    _0143_ = CPU_clk_arun_a0;
  end
  always @(posedge clk) begin
      CPU_clk_arun_a1 <= _0143_;
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
    _0144_ = CPU_clk_arun_a1;
  end
  always @(posedge clk) begin
      CPU_clk_arun_a2 <= _0144_;
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
    _0145_ = CPU_clk_arun_a2;
  end
  always @(posedge clk) begin
      CPU_clk_arun_a3 <= _0145_;
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
    _0146_ = CPU_clk_arun_a3;
  end
  always @(posedge clk) begin
      CPU_clk_arun_a4 <= _0146_;
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
    _0147_ = CPU_clk_arun_a4;
  end
  always @(posedge clk) begin
      CPU_clk_arun_a5 <= _0147_;
  end
  always @* begin
    if (\$auto$verilog_backend.cc:2352:dump_module$671 ) begin end
